...
# ------------------------------------------------------------------------------
# Run a Test:
# floyd run --gpu --data adityatb/datasets/mir1k/2:mir1k --env tensorflow-1.12 "python3 TrainNetBSS.py"
#
# Run on Full Dataset:
# floyd run --gpu --data adityatb/datasets/mir1k/1:mir1k --env tensorflow-1.12 "python3 TrainNetBSS.py"
# ------------------------------------------------------------------------------
# CPU:
# ------------------------------------------------------------------------------
# Run a Test:
# floyd run --cpu2 --data adityatb/datasets/mir1k/2:mir1k --env tensorflow-1.12 "python3 TrainNetBSS.py"
#
# Run on Full Dataset:
# floyd run --cpu2 --data adityatb/datasets/mir1k/1:mir1k --env tensorflow-1.12 "python3 TrainNetBSS.py"
# ------------------------------------------------------------------------------
...
#
# combinedDataFrames = list(zip(voiceData,musicAddedData,musicData))
# random.shuffle(combinedDataFrames)
# voiceData[:],musicAddedData[:],musicData[:] = zip(*combinedDataFrames)
